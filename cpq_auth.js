...
(function () {
  ...
  var CSS = [
    ...
    '.cpq-auth-tab.on{color:var(--color-primary,#0060E6);border-bottom-color:var(--color-primary,#0060E6);font-weight:600;}',
    ...
    '.cpq-auth-f input:focus,.cpq-auth-f select:focus{border-color:var(--color-primary,#0060E6);}',
    ...
    '.cpq-auth-btn.primary{background:var(--color-primary,#0060E6);color:#fff;}',
    ...
    'justify-content:center;font-size:17px;font-weight:650;color:#fff;background:var(--color-primary,#0060E6);}',
    ...
    'background:rgba(0,96,230,.12);color:var(--color-primary,#0060E6);}',
