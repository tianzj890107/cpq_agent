...
(function () {
  ...
  var CSS = [
    ...
    '.cpq-msg-hd a{font-size:12px;font-weight:400;color:var(--color-primary,#0060E6);cursor:pointer;}',
    ...
    '.cpq-msg-item.unread{border-left-color:var(--color-primary,#0060E6);background:rgba(0,96,230,.05);}',
    ...
    'cursor:pointer;border-left:3px solid var(--color-primary,#0060E6);animation:cpqToastIn .25s ease;}',
