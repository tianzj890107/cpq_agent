...
var homeDwgNote = window.CPQ_DWG_CAPABILITY_NOTE;
...
function renderHomeBase() {
  document.querySelector('#app').innerHTML=`<div class="home-shell">
    ...
    <main class="page-container home-main"><section class="chat-container">
      ...
      <section class="unified-input-card"><div class="unified-content"><p class="unified-intro">请使用 @ 引用需求编号，或直接上传文件内容（图纸、文档等），开始解析工艺、生成方案。</p><div class="format-row"><span class="format-label">支持格式：</span><span class="format-label">3D 格式</span><div class="format-tags-row"><span class="format-tag-inline">STEP</span><span class="format-tag-inline">STP</span><span class="format-tag-inline">SLDPRT</span><span class="format-tag-inline">STL</span><span class="format-tag-inline">SAT</span></div><span class="format-label">2D 格式</span><div class="format-tags-row"><span class="format-tag-inline">DWG</span><span class="format-tag-inline">DXF</span><span class="format-tag-inline">PDF</span></div></div><p class="format-note">${homeDwgNote}</p></div><div class="upload-names" id="uploadNames" aria-live="polite"></div><textarea id="homePrompt" class="unified-textarea" maxlength="200" placeholder="请输入你的问题或需求描述..." rows="3"></textarea><div class="unified-input-area"><label class="upload-section" for="modelFile"><input id="modelFile" class="upload-input" type="file" accept="image/*,.pdf,.dwg,.dxf,.step,.stp,.sldprt,.stl,.sat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg><span>上传模型图纸</span></label><label class="upload-section" for="documentFiles"><input id="documentFiles" class="upload-input" type="file" multiple accept="image/*,.pdf,.txt,.md,.csv,.doc,.docx"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg><span>上传需求文档</span></label><span class="char-counter" id="charCounter">0/200</span><button class="send-btn" id="sendBtn" aria-label="创建需求"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg></button></div></section>
