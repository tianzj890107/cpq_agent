...
function cfSubLabel(no){var a=(typeof window!=='undefined'&&window.CpqWorkflowStages)||{};return typeof a.subLabel==='function'?a.subLabel(no):String(no||'');}
/* 确认需求页：默认展示本地规则；仅点击“AI 检查”才会调用模型。 */
